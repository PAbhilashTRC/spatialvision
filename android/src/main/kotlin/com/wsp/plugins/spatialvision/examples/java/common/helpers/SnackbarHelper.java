 ...
 */
package com.wsp.plugins.spatialvision.examples.java.common.helpers;
...
public final class SnackbarHelper {
  ...
  public void showMessage(GeoSpatial activity, String message) {
  ...
  public void showMessageWithDismiss(GeoSpatial activity, String message) {
   ...
   */
  public void showError(GeoSpatial activity, String errorMessage) {
  ...
  private void show(
          final GeoSpatial activity, final String message, final DismissBehavior dismissBehavior) {
        ...
        new Runnable() {
          ...
          public void run() {
            messageSnackbar =
                Snackbar.make(
                    snackbarView == null
                        ? activity.getActivity().findViewById(android.R.id.content)
                        : snackbarView,
                    message,
